...
+--------+-----------------------------+------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------+
| GET    | api/status/inventory        | hostvar=[node]   | nodes variables from *meta without deployemnts \| Used by Ansible python --host client \| \| GET \| api/status/inventory \| hostvar=none \| All deployments without node *\ meta data   | Used by Ansible python --list client   |
+--------+-----------------------------+------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------+
